...
yubihsm-shell.exe -p password -a put-asymmetric-key -i $import_keyid -l "ecKeyImport" -d "2,6,7" -c "sign-ecdsa" --in=secp224r1-keypair.pem; CheckExitStatus -ECode $?
...
yubihsm-shell.exe -p password -a put-asymmetric-key -i $import_keyid -l "ecKeyImport" -d "1,2,3,4,5" -c "sign-ecdsa" --in=secp256r1-keypair.pem; CheckExitStatus -ECode $?
yubihsm-shell.exe -p password -a get-public-key -i $import_keyid --outformat=PEM; CheckExitStatus -ECode $?
#-- Sign
...
#-- Sign attestation certificate
yubihsm-shell.exe -p password -a put-opaque -i $import_keyid -l template_cert -A opaque-x509-certificate --in cert.der; CheckExitStatus -ECode $?
yubihsm-shell.exe -p password -a sign-attestation-certificate -i $import_keyid --attestation-id=$keyid --out selfsigned_cert.der; CheckExitStatus -ECode $?
#-- Derive ECDH
...
yubihsm-shell.exe -p password -a put-asymmetric-key -i $import_keyid -l "ecKeyImport" -d "1,2,3,4,5" -c "sign-ecdsa" --in=secp384r1-keypair.pem; CheckExitStatus -ECode $?
yubihsm-shell.exe -p password -a get-public-key -i $import_keyid --outformat=PEM; CheckExitStatus -ECode $?
#-- Sign
...
yubihsm-shell.exe -p password -a put-asymmetric-key -i $import_keyid -l "ecKeyImport" -d "1,2,3,4,5" -c "sign-ecdsa" --in=secp521r1-keypair.pem; CheckExitStatus -ECode $?
yubihsm-shell.exe -p password -a get-public-key -i $import_keyid --outformat=PEM; CheckExitStatus -ECode $?
#-- Sign
...
yubihsm-shell.exe -p password -a put-asymmetric-key -i $import_keyid -l "ecKeyImport" -d "1,2,3,4,5" -c "sign-ecdsa" --in=secp256k1-keypair.pem; CheckExitStatus -ECode $?
yubihsm-shell.exe -p password -a get-public-key -i $import_keyid --outformat=PEM; CheckExitStatus -ECode $?
#-- Sign
...
yubihsm-shell.exe -p password -a put-asymmetric-key -i $import_keyid -l "ecKeyImport" -d "1,2,3,4,5" -c "sign-ecdsa" --in=brainpool256r1-keypair.pem; CheckExitStatus -ECode $?
yubihsm-shell.exe -p password -a get-public-key -i $import_keyid --outformat=PEM; CheckExitStatus -ECode $?
#-- Sign
...
yubihsm-shell.exe -p password -a put-asymmetric-key -i $import_keyid -l "ecKeyImport" -d "1,2,3,4,5" -c "sign-ecdsa" --in=brainpool384r1-keypair.pem; CheckExitStatus -ECode $?
yubihsm-shell.exe -p password -a get-public-key -i $import_keyid --outformat=PEM; CheckExitStatus -ECode $?
#-- Sign
...
yubihsm-shell.exe -p password -a put-asymmetric-key -i $import_keyid -l "ecKeyImport" -d "1,2,3,4,5" -c "sign-ecdsa" --in=brainpool512r1-keypair.pem; CheckExitStatus -ECode $?
yubihsm-shell.exe -p password -a get-public-key -i $import_keyid --outformat=PEM; CheckExitStatus -ECode $?
#-- Sign
