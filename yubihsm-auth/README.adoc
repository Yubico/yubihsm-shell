...
[source, bash]
----
$ yubihsm-auth -a put --name="default key" --derivation-password="password" --password="my secret"
...
[source, bash]
----
$ yubihsm-shell -a get-pseudo-random --ykhsmauth-name="default key" --password="my secret"
